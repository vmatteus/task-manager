...
class HttpCode
{
    ...
    public static function getValidCode($code, $default = 404)
    {
        $httpCode = new reflectionClass(__CLASS__);
        $codes = $httpCode->getConstants();

        return in_array($code, $codes) ? $code : $default;
    }
}
